...
import { Activity, User, Calendar, LineChart, BarChart, Gauge, ChevronRight, ChevronLeft, Flag } from 'lucide-react';
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild tooltip="Забег">
                  <Link to="/race" className="flex items-center space-x-3">
